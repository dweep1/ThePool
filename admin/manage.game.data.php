...
<div class="fluid-row width-90 alignleft no-padding">
    <form action="listn.games.php" id="subForm" method="post">
        ...
        <div class="fluid-row slim">
            <label for="username">Away Score: </label> <input type="text" class="float-right" no-default id="year" name="year" value="<?php echo $obj->away_score; ?>" />
            <div class="clear-fix"></div>
        </div>
        ...
        <div class="fluid-row slim">
            <label for="paypal">Home Score: </label> <input type="text" class="float-right" no-default id="game_count" name="game_count" value="<?php echo $obj->home_score; ?>" />
            <div class="clear-fix"></div>
        </div>
